...
// Complete tutorial code, Part 1-3 by Lawrence M
//
// Disclaimer:
//--------------------------------------------------------
...
public class x360_Gamepad
{
	...
	public bool GetTriggerTap_L() {
		return (LT.prev_value <= 0.1f && LT.current_value >= 0.1f) ? true : false;
	}

	// Check if right trigger was tapped - on CURRENT frame
	public bool GetTriggerTap_R() {
		return (RT.prev_value <= 0.1f && RT.current_value >= 0.1f) ? true : false;
	}
